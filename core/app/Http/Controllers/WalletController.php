...
class WalletController extends Controller
{
    ...
    {
        $wallet_logs = WalletLog::whereUserId(auth()->id())->paginate(10);
        return view('frontend.customer.wallet',compact('wallet_logs'));
    }
    public function refundRequest()
    {
        $refund_records = Payout::whereUserId(auth()->id())->paginate(10);
        return view('frontend.customer.payout-request',compact('refund_records'));
    }
