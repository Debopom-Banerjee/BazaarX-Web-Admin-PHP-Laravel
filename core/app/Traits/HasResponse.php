...
trait HasResponse
{
    ...
    public function success($data, $statusCode = 200)
    {
        ...
        // }
        return response()->json(['message' => "success", "status" => "success", 'data' => $data], $statusCode);
    }
    ...
    {
        return response()->json(['message' => $message, "status" => "success"], $statusCode);
    }
    ...
    {
        return response()->json(['message' => $message, "status" => "error"], $statusCode);
    }
