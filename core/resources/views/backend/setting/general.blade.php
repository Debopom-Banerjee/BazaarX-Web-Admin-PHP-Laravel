                    ...
                    <div role="tabpanel">
                        <div class="card-header" style="border:none;">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="#inviter" class="nav-link" aria-controls="inviter" role="tab"
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade show active pt-3" id="general"
                                    ...
                                    <form class="forms-sample" action="{{ route('panel.setting.general.store') }}"
                                        ...
                                        <div class="form-group row">
                                            <label for="exampleInputUsername2"
                                                class="col-sm-3 col-form-label">{{ __('Top Offer') }}<span class="text-red">*</span>
                                            </label>
                                            <div class="col-sm-9">
                                                <textarea name="top_offer" rows="3" class="form-control"
                                                required placeholder="Enter Top Offer Title">{{ getSetting('top_offer') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
...
{{-- 
                                ...
                                <!--tab panel Inviter Percent-->
                                    <div role="tabpanel" class="tab-pane fade show pt-3" id="inviter" aria-labelledby="inviter-tab">
                                        <form class="forms-sample" action="{{ route('panel.setting.dnt.store') }}"
                                            method="post">
                                            @csrf
                                            <input type="hidden" name="group_name" value="{{ 'inviter_details' }}">
                                            <div class="form-group d-flex mb-2">
                                                <label for="" class="col-sm-3">{{ __('Value (in%)') }}<span class="text-red">*</span>
                                                </label>
                                                <input type="number" class="form-control" name="inviter_percent"  value="{{ getSetting('inviter_percent') }}">
                                            </div>
                                            <div class="d-flex justify-content-end">
                                                <div class="alert alert-info col-9" role="alert" style="padding: 0.4rem 0.75rem;">
                                                    <span class="fw-600">This is the percentage that we will give to the inviter on every order placed.</span>
                                                </div>
                                            </div>
                                            <div class="card-footer text-right">
