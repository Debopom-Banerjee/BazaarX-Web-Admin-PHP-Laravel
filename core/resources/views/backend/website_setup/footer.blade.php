...
@endpush
			...
			<div class="col-md-10 mx-auto">
				<div class="card">
					<ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" id="pills-profile-tab" data-toggle="pill" href="#last-month" role="tab" aria-controls="pills-profile" aria-selected="false">{{ __('Footer')}}</a>
						</li>
						{{-- <li class="nav-item">
	...
	{{-- <div class="copyclipboard" style=" display: flex;    justify-content: space-between;">
		<div class="copy-text">
			<button data-toggle="tooltip" data-placement="top" title="Copy Clipboard"><i class="fa fa-clone"></i></button>
			AWB No:<input type="text" class="text" value="{{ $order->awp_no }}">

		</div>
		<a href="https://app.bigship.in/shipment-tracking" target="_blank" class="details-btn">Track Order</a>
	</div> --}}
