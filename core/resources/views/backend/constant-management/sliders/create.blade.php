                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group {{ $errors->has('link') ? 'has-error' : ''}}">
                                        ...
                                        <input class="form-control" name="link" type="text" id="link" value="{{old('link')}}" placeholder="Enter Link">
                                    </div>
                                </div>
                                <div class="col-md-12 col-12">
                                    <div class="form-group {{ $errors->has('app_link') ? 'has-error' : ''}}">
                                        <label for="app_link" class="control-label">App Link</label>
                                        <input class="form-control" name="app_link" type="text" id="app_link" value="{{old('link')}}" placeholder="Enter Link">
                                    </div>
                                </div>
