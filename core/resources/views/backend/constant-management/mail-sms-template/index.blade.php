            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <form class="d-flex" method="get" action="{{ route('panel.constant_management.mail_sms_template.index') }}">
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                                        <li class="dropdown-item p-0"><a href="{{ route('panel.constant_management.mail_sms_template.show', $item->id) }}" title="View Mail/SMS Template Contact" class="btn btn-sm">Show</a></li>
                                                        <li class="dropdown-item p-0"><a href="{{ route('panel.constant_management.mail_sms_template.edit', $item->id) }}" title="Edit Mail/SMS Template Contact" class="btn btn-sm">Edit</a></li>
