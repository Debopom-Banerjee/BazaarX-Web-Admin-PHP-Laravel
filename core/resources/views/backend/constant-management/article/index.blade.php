                    ...
                    <div class="card">
                        <div class="card-header d-flex flex-wrap justify-content-between">
                            ...
                            <div class="d-flex flex-wrap justicy-content-right mt-2">
                                ...
                                <div class="form-group mb-0 mr-2">
                                    <select id="type" name="category" class="select2 form-control course-filter">
                                        <option readonly value="">{{ __('All Category') }}</option>
                                ...
                                <div class="form-group mb-0 mr-2">
                                    <select name="type" class="form-control">
                                        <option readonly value="">{{ __('All Type') }}</option>
                                        <option value="1" {{ 1 == request()->get('type') ? 'selected': ''}}>Blogs</option> 
                                        <option value="2" {{ 2 == request()->get('type') ? 'selected': ''}}>Resources</option> 
                                    </select>
                                </div>
