                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Banner </th>
                                        <td><img src="{{ ($article && $article->description_banner) ? asset('storage/backend/article/'.$article->description_banner) : asset('backend/default/default-avatar.png') }}" class="" style="object-fit: fill; width: 100%; height: 300px" /> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
