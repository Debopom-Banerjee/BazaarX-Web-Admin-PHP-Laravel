                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
                                                ...
                                                <select required name="type" id="type" class="form-control select2">
                                                        <option  readonly>{{ __('Select Type')}}</option>
                                                        <option value="1"@if($article->type == 1) selected @endif>Blogs</option> 
                                                        <option value="2" @if($article->type == 2) selected @endif>Resources</option> 
                                                </select>
                                            </div>
                                        </div>
                                    </div>
