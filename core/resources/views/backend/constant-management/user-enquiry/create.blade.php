                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
                                                ...
                                                <input class="form-control" name="type" type="text" id="type" value="" placeholder="Enter Type" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('type_value') ? 'has-error' : ''}}">
                                                ...
                                                <input class="form-control" name="type_value" type="text" id="type_value" value="" placeholder="Enter Email id or Contact Number" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
