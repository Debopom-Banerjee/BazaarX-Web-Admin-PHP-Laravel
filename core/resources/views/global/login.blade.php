            ...
            <div class="col-12">
                <div class="card form-signin p-4 rounded shadow">
                    <form method="post" action="{{ route('login') }}">
                        @csrf
                        {{-- <input type="hidden" name="role" value="@if(request()->get('role') == 'User') 3 @else  @endif"> --}}
                        <a href="{{url('/')}}">
                            <img src="{{ getBackendLogo(getSetting('app_white_logo')) }}" class="avatar avatar-small mb-4 d-block mx-auto" alt="website-logo" style="height: 100%;width:20%;">
                        </a>
                        ...
                        <div class="col-12 text-center mt-3">
                            <p class="mb-0 mt-3">Are you a
                                <a href="{{route('register',['role' => 'partner'])}}">Partner</a>
                                Or
