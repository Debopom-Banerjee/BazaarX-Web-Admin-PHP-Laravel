                ...
                <div class="col-12">
                    <div class="card form-signin p-4 rounded shadow mt-5" >
                        ...
                        <form action="{{ url('register') }}" method="post" class="mt-3">
                            @csrf
                            <input type="hidden" name="role" value="@if(request()->get('role') == 'partner') 4 @else 3 @endif">
                            <a href="{{url('/')}}">
                                <img src="{{ getBackendLogo(getSetting('app_white_logo')) }}" class="avatar avatar-small mb-4 d-block mx-auto" alt="website-logo" style="height: 100%;width:50%;">
                            </a>
                            ...
                            <div class="form-check mb-3">
                                ...
                                <label class="form-check-label" for="flexCheckDefault">I Accept <a href="{{url('page/terms')}}" class="text-primary">Terms & </a><a href="{{url('page/privacy')}}" class="text-primary">Policy</a></label>
                            </div>
