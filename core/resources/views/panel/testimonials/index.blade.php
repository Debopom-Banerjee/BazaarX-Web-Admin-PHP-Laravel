 ...
 */
    $breadcrumb_arr = [
        ['name'=>'Testimonials', 'url'=> "javascript:void(0);", 'class' => 'active']
    ]
    @endphp
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('panel.user_addres.index') }}" method="GET" id="TableForm">
            <div class="row">
                <!-- start message area-->
                <!-- end message area-->
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="d-flex justicy-content-right">
                                ...
                                <a href="javascript:void(0);" id="reset" data-url="{{ route('panel.testimonial.index') }}" class="btn btn-icon btn-sm btn-outline-danger mr-2" title="Reset"><i class="fa fa-redo" aria-hidden="true"></i></a>
                                <a href="{{ route('panel.testimonial.add') }}" class="btn btn-icon btn-sm btn-outline-primary" title="Add New User Addre"><i class="fa fa-plus" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div id="ajax-container">
                            @include('panel.testimonials.load')
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="https://unpkg.com/xlsx@0.15.1/dist/xlsx.full.min.js"></script>
        ...
        function html_table_to_excel(type)
        {
            ...
            XLSX.writeFile(file, 'UserAddresFile.' + type);
