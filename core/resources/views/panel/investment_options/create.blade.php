 ...
 */
$breadcrumb_arr = [
    ['name'=>'Add Investment Option', 'url'=> "javascript:void(0);", 'class' => '']
]
@endphp
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add Investment Option</h5>
                            <span>Create a record for Investment Option</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-8 mx-auto">
               ...
               @include('backend.include.message')
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form action="{{ route('panel.investment_options.store') }}" method="post" enctype="multipart/form-data" id="InvestmentOptionForm">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('mutual_fund') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="mutual_fund" type="text" id="mutual_fund" value="{{old('mutual_fund')}}" placeholder="Enter Mutual Fund" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('allocation') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="allocation" type="text" id="allocation" value="{{old('allocation')}}" placeholder="Enter Allocation" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('scrip_name') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="scrip_name" type="text" id="scrip_name" value="{{old('scrip_name')}}" placeholder="Enter Scrip Name" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-12"> 
                                    <div class="form-group {{ $errors->has('tenure') ? 'has-error' : ''}}">
                                        ...
                                        <input required  class="form-control" name="tenure" type="text" id="tenure" value="{{old('tenure')}}" placeholder="Enter Tenure" >
                                    </div>
                                </div>
