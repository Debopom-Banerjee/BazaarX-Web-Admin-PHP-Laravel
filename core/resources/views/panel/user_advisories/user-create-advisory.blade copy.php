                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group">
                                            ...
                                            <input  class="form-control" name="assets_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="assets_amount" value="{{old('assets_amount')}}" placeholder="Amount in total" >
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group {{ $errors->has('stock_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="stock_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="stock_amount" value="{{old('stock_amount')}}" placeholder="Amount in total" >
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group {{ $errors->has('debet_instrument_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="debet_instrument_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="debet_instrument_amount" value="{{old('debet_instrument_amount')}}" placeholder="Amount in total" >
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group {{ $errors->has('precious_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="precious_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="precious_amount" value="{{old('precious_amount')}}" placeholder="Amount in total" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group {{ $errors->has('other_liablities_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="other_liablities_amount" min="0" oninput="this.value =!!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="other_liablities_amount" value="{{old('other_liablities_amount')}}" placeholder="Amount in total" >
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <div class="form-group {{ $errors->has('personal_loan_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="personal_loan_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="personal_loan_amount" value="{{old('personal_loan_amount')}}" placeholder="Amount in total" >
                                    ...
                                    <div class="col-md-6 col-12 mb-4">
                                        <div class="form-group {{ $errors->has('short_loan_amount') ? 'has-error' : ''}}">
                                            ...
                                            <input  class="form-control" name="short_loan_amount" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null"type="number" id="short_loan_amount" value="{{old('short_loan_amount')}}" placeholder="Amount in total" >
