            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Add User Advisory</h5>
                            <span>Create a record for User Advisory</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <form method="post" action="{{route('panel.user_advisories.store')}}" id="UserAdvisoryForm" >
            ...
            {{-- profile form start --}}
                <div class="row parentForm " data-id="1" style="position: relative">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100 ">
                                                ...
                                                <div class="form-group w-50 m-2 ">
                                                    ...
                                                    <span id="first_name_msg" class="d-none text-danger" > Name is required </span>
                                                </div>
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-50 m-2">
                                                    ...
                                                    <select required name="no_dependents" id="no_dependents" class="form-control select2" >
                                                            <option value="" readonly>Select Dependents </option>
                                                ...
                                                <div class="form-group w-50 m-2">
                                                    <label for="salary_business">Are You Salaried/Business
                                                        <span class="text-danger">*</span>
                                                    </label>
                                                    <select required name="salary_business" id="salary_business" class="form-control select2" >
                                                        <option value="" readonly>Select Salaried/Business </option>
                    ...
                    <button type="button" class="btn btn-primary next-step " style="position: absolute; top:80%;left:74%; " id="profilebtn">Next</button>
            ...
            {{-- balance form start --}}
                <div class="row parentForm" data-id="2">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('stock') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('stock_amount') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('debet_instrument') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('debet_instrument_amount') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('assests') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('precious_amount') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('other_liablities') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('other_liablities_amount') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100">
                                                <div class="form-group w-50 m-2 {{ $errors->has('personal_loan') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('personal_loan_amount') ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-md-12 col-12 "> 
                                            <div class="d-flex w-100 mb-4">
                                                <div class="form-group w-50 m-2 {{ $errors->has('short_loan') ? 'has-error' : ''}}">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('short_loan_amount') ? 'has-error' : ''}}">
                    ...
                    <button type="button" class="btn btn-primary next-step float-right" style="position: relative; left:-220px;top:-70px" id="balancebtn">Next</button>
                    <button type="button" class="btn btn-primary previous-step float-right" style="position: relative; left:-230px;top:-70px">Previous</button>
                </div>
            {{-- balance form end --}}
            ...
            {{-- goal form start --}}
                <div class="row parentForm " data-id="3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12 "> 
                                        <div class="d-flex w-100">
                                            ...
                                            <div class="form-group w-60 m-2 {{ $errors->has('vacation') ? 'has-error' : ''}}">
                                            ...
                                            <div class="form-group w-40 m-2 {{ $errors->has('vacation_years') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12 col-12 "> 
                                        <div class="d-flex w-100">
                                            ...
                                            <div class="form-group w-60 m-2 {{ $errors->has('collage_education') ? 'has-error' : ''}}">
                                            ...
                                            <div class="form-group w-40 m-2 {{ $errors->has('user_detail') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12 col-12 "> 
                                        <div class="d-flex w-100">
                                            ...
                                            <div class="form-group w-60 m-2 {{ $errors->has('house_property') ? 'has-error' : ''}}">
                                            ...
                                            <div class="form-group w-40 m-2 {{ $errors->has('house_property_year') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12 col-12 "> 
                                        <div class="d-flex w-100">
                                            ...
                                            <div class="form-group w-60 m-2 {{ $errors->has('retirement') ? 'has-error' : ''}}">
                                            ...
                                            <div class="form-group w-40 m-2 {{ $errors->has('retirement_year') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-12 col-12 "> 
                                        <div class="d-flex w-100 mb-4">
                                            ...
                                            <div class="form-group w-60 m-2 {{ $errors->has('collage_education2') ? 'has-error' : ''}}">
                                            ...
                                            <div class="form-group w-40 m-2 {{ $errors->has('collage_education_year2') ? 'has-error' : ''}}">
                    ...
                    <button type="button" class="btn btn-primary next-step float-right" style="position: relative; left:-220px;top:-70px" id="goalsbtn">Next</button>
                    <button type="button" class="btn btn-primary previous-step float-right" style="position: relative; left:-230px;top:-70px">Previous</button>
                </div>
            {{-- goal form end --}}
            ...
            {{-- budget form start --}}
                <div class="row  parentForm " data-id="4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12 mt-4"> 
                                            ...
                                            <div class="d-flex w-100">
                                                ...
                                                <div class="form-group w-50 m-2 {{ $errors->has('insurance_expenses') ? 'has-error' : ''}}">
                    ...
                    <button type="button" class="btn btn-primary next-step float-right" style="position: relative; left:-220px;top:-70px" id="budgetbtn">Next</button>
                    <button type="button" class="btn btn-primary previous-step float-right" style="position: relative; left:-230px;top:-70px">Previous</button>
                </div>
            {{-- budget form end --}}
            ...
            {{-- risk score form start --}}
                <div class="row parentForm" data-id="5">
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="job_secure">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="No"  name="job_secure" />
                                                                <h6 style="margin-top: 5px; font-size:12px">No</h6>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Somewhat" name="job_secure" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Very secure" name="job_secure" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="paying_loans">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="1 - 2 years"  name="paying_loans"  />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Yes" name="paying_loans" />
                                                                <h6 style="margin-top: 5px; font-size:12px">Yes</h6>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="I've no loans" name="paying_loans" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="bougth_stock">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="1 - 2 years"  name="bougth_stock"  />
                                                                <h6 style="margin-top: 5px; font-size:12px">1 - 2 yrs</h6>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="2 - 5 years" name="bougth_stock" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Less then 5yrs" name="bougth_stock" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="mutual_fund">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="0 - 10%"  name="mutual_fund"/>
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="20 - 50%" name="mutual_fund" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Less then 50%" name="mutual_fund" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="decling">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Sell all"  name="decling"  />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Sell some" name="decling" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Do nothing" name="decling" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="save_income">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Less then 10%" name="save_income"  />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="10 - 30%" name="save_income" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="More then 30%" name="save_income" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="invest">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Less then 1 years" name="invest"  />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="1 - 3 years" name="invest" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="More then 3 years" name="invest" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="lost_bear">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Less then 10%"  name="lost_bear"  />
                                                                <h6 style="margin-top: 5px; font-size:12px">Less then 10%</h6>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="10 - 20%" name="lost_bear" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="More then 20%" name="lost_bear" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="financial_risk">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label"> 
                                                                <input type="radio" class="form-check-input" value="Low"  name="financial_risk"  />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="Medium" name="financial_risk" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="High" name="financial_risk" />
                                            ...
                                            <div class="d-flex w-100">
                                                <div class="form-group w-100 m-2">
                                                    ...
                                                    <div class="d-flex" id="avg_salary">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input"  name="avg_salary" value="Less then 8%" />
                                                        ...
                                                        <div class="form-check ml-2">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" name="avg_salary" value="8 - 15%" />
                                                        ...
                                                        <div class="form-check ml-2 mb-4">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="form-check-input" value="More then 15%" name="avg_salary" />
                    ...
                    <button type="submit" class="btn btn-primary submit-form float-right" style="position: relative; left:-220px;top:-70px" id="riskbtn">Submit</button>
                    <button type="button" class="btn btn-primary previous-step float-right" style="position: relative; left:-230px;top:-70px">Previous</button>
    ...
    <script>
       ...
       var nxt = false
        ...
        $(document).ready(function () {
            ...
            //         var id = this.getAttribute('data-li');
            ...
            //             }else{
            //             document.querySelector(`[data-id="${i}"]`).classList.remove('d-block')
