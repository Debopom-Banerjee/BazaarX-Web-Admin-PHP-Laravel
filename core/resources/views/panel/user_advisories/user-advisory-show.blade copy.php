...
$net_worth_short_term_amount =  ($net_worth_assests->other_liablities_amount) - ($net_worth_liabilities->short_loan_amount) > 0 ? ($net_worth_assests->other_liablities_amount) - ($net_worth_liabilities->short_loan_amount) : 0;
...
$net_wroth_surplus_asset_check = $net_worth_surplus_asset > 0 ? $net_worth_surplus_asset : 0;
$net_worth_current_asset = ($net_worth_assests->other_liablities_amount) + ($net_wroth_surplus_asset_check);
$net_worth_current_equity = ($net_worth_current_asset) - ($net_worth_liabilities->short_loan_amount + 0);
$net_worth_current_equity_min = $net_worth_current_equity > 0 ? $net_worth_current_equity : 0;
...
$fin_ratio_actual_liquidity_ratio = (($net_worth_current_equity_min) / ($exp_monthly)) * 100;
        ...
        <div class="col-12 mx-auto">
          <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="col-lg-8 col-12">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <tr>
                            <td>Total Income</td>
                            <td>{{explode('.',format_price($budget_sources))[0]}}</td>
                            <td>{{explode('.',format_price($annual_income))[0]}}</td>
                            <td>100%</td>
                          </tr>
                          <tr>
                            <td>Total Expenses</td>
                            {{-- @dd($bud_income) --}}
                            <td>{{explode('.',format_price($exp_monthly))[0]}}</td>
                            <td>{{explode('.',format_price($annual_exp))[0]}}</td>
                            <td>{{round($exp_percent)}}%</td>
                          </tr>
                          <tr>
                            <td>Total Savings</td>
                            <td>{{explode('.',format_price($saving_monthly))[0]}}</td>
                            <td>{{explode('.',format_price($annual_saving))[0]}}</td>
                      ...
                      <table class="table table-striped table-responsives">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>{{explode('.',format_price($net_worth_assests->assets_amount ?? ''))[0]}}</td>
                            <td>
                              <ul class="list-unstyled">
                                  @foreach ($net_worth_liabilities->personal_loan as $item)
                                      <li>{{$item}}</li>
                                  @endforeach
                                  : {{explode('.',format_price($net_worth_liabilities->personal_loan_amount))[0]}}
                              </td>
                              </ul>
                            <td> {{explode('.',format_price($net_worth_equity))[0]}} </td>
                          </tr>
                          <tr>
                            <td>
                              <ul class="list-unstyled">
                            ...
                            <td>{{explode('.',format_price($net_worth_assests->stock_amount))[0]}} </td>
                            <td>
                                <ul class="list-unstyled">
                            ...
                            <td>{{explode('.',format_price(($net_worth_liabilities->short_loan_amount) - 0))[0]}}</td>
                          </tr>
                          <tr>
                            <td>
                              <ul class="list-unstyled">
                            ...
                            <td>{{explode('.',format_price($net_worth_assests->debet_instrument_amount))[0]}}</td>
                            <td>0 : </td>
                            <td>{{explode('.',format_price(($net_worth_assests->debet_instrument_amount) - 0))[0]}}</td>
                          </tr>
                          <tr>
                            <td>
                              <ul class="list-unstyled">
                            ...
                            <td>{{explode('.',format_price($net_worth_assests->precious_amount))[0]}}</td>
                            <td> - , -</td>
                            <td> {{explode('.',format_price(($net_worth_assests->precious_amount) - 0))[0]}}</td>
                          </tr>
                          <tr>
                            <td><strong>Fixed Assets</strong></td>
                            <td><strong>{{explode('.',format_price($fixed_assets_amount))[0]}}</strong> </td>
                            <td><strong> LT Liab :  {{explode('.',format_price($fixed_assets_loan_amount))[0]}}</strong> </td>
                            <td><strong>{{explode('.',format_price($fixed_assets_net_worth_amount))[0]}}</strong> </td>
                          </tr>
                          <tr>
                            <td>
                              <ul class="list-unstyled">
                            ...
                            <td> {{explode('.',format_price($net_worth_assests->other_liablities_amount))[0]}} </td>
                            <td>
                              <ul class="list-unstyled">
                                @foreach ($net_worth_liabilities->short_loan as $item)
                                    <li>{{$item}}</li>
                                @endforeach
                                : @if($net_worth_liabilities->short_loan_amount > 0)
                                  {{explode('.',format_price($net_worth_liabilities->short_loan_amount))[0]}}
                                @else
                                  0
                                @endif
                              </td>
                              </ul>
                            <td> {{explode('.',format_price($net_worth_short_term_amount))[0]}}</td>
                          </tr>
                          <tr>
                            <td>Surplus</td>
                            <td> {{explode('.',format_price($net_wroth_surplus_asset_check))[0]}} </td>
                            <td> - </td>
                            <td> {{explode('.',format_price($net_wroth_surplus_asset_check - 0))[0]}} </td>
                          </tr>
                          <tr>
                            <td><strong>Current</strong></td>
                            <td> <strong>{{explode('.',format_price($net_worth_current_asset))[0]}}</strong> </td>
                            <td><strong>ST Liab : {{explode('.',format_price($net_worth_liabilities->short_loan_amount + 0))[0]}}</strong></td>
                            <td> <strong>{{explode('.',format_price($net_worth_current_equity_min))[0]}}</strong>  </td>
                          </tr>
                          <tr>
                            <td>Total Assets </td>
                            <td>{{explode('.',format_price($net_worth_total_assets))[0]}}</td> 
                            <td>Total Liability : {{explode('.',format_price($net_worth_total_liability))[0]}} </td>
                            <td>{{explode('.',format_price($net_worth_total_assets_enquity))[0]}} </td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <table class="table table-striped table-responsives">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td> {{explode('.',format_price($risk_life_insurance_optimum_coverage))[0]}} </td>
                        <td>{{explode('.',format_price(round($risk_life_insurance_approx_premium)))[0]}} </td>
                        <td> {{explode('.',format_price($bud_income->life_insurance_amount))[0]}} </td>
                      </tr>
                      <tr>
                        <td>Medical Insurance</td>
                        <td>{{$medical_insurance_amount->coverage_required_for_family}} </td>
                        <td>{{explode('.',format_price($medical_insurance_amount->approx_premium))[0]}} </td>
                        <td> {{explode('.',format_price($bud_income->medical_amount))[0]}} </td>
                      </tr>
                      <tr>
                    ...
                    <div class="row mt-3">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td> {{explode('.',format_price($asset_allocation_debt_advisable))[0]}} - 
                          ...
                          <td> {{explode('.',format_price($asset_allocation_debt_old_portfolio))[0]}} </td>
                          <td> {{explode('.',format_price($asset_allocation_debt_advised_portfolio))[0]}} -FD,PPF </td>
                        </tr>
                        <tr>
                          ...
                          <td> {{explode('.',format_price($asset_allocation_assets_advisable))[0]}} - 
                          ...
                          <td> {{explode('.',format_price($asset_allocation_asset_old_portfolio))[0]}} </td>
                          <td>{{explode('.',format_price($asset_allocation_asset_advised_portfolio))[0]}} -Property </td>
                        </tr>
                        <tr>
                          ...
                          <td>{{explode('.',format_price($asset_allocation_enquity_advisable))[0]}} - 
                          ...
                          <td> {{explode('.',format_price($asset_allocation_enquity_old_portfolio))[0]}} </td>
                          <td> {{explode('.',format_price($asset_allocation_enquity_advised_portfolio))[0]}} - Stock/MF </td>
                        </tr>
                        <tr>
                          ...
                          <td> {{explode('.',format_price($asset_allocation_alternative_investment_advisable))[0]}} - 
                          ...
                          <td> {{explode('.',format_price($asset_allocation_alternative_investment_old_portfolio))[0]}} </td>
                          <td>{{explode('.',format_price($asset_allocation_alternative_investment_advised_portfolio))[0]}} - Gold </td>
                        </tr>
                        <tr>
                          <td>Cash & Surplus </td>
                          <td> {{$asset_allocation_cash_and_surplush_current}}% </td>
                          <td> {{explode('.',format_price($net_worth_current_asset))[0]}} </td>
                          <td> {{round($asset_allocation_cash_and_surplus_advised,2)}}%</td>
                          <td> {{explode('.',format_price($asset_allocation_cash_and_surplus_advisable))[0]}} - 
                          ...
                          <td> {{explode('.',format_price($asset_allocation_cash_and_surplus_old_portfolio))[0]}} </td>
                          <td> {{explode('.',format_price($asset_allocation_cash_and_surplus_advised_portfolio))[0]}} - Emergency</td>
                        </tr>
                        <tr>
                          <td></td>
                          <td>{{$asset_allocation_total_current_balance_in_percent}}% </td>
                          <td> {{explode('.',format_price($asset_allocation_total_current_balance))[0]}} </td>
                          <td> {{$asset_allocation_total_advised}}%</td>
                          <td> {{explode('.',format_price($asset_allocation_total_advisable))[0]}} </td>
                          <td> {{round($asset_allocation_total_expected_return)}}% </td>
                          <td> {{explode('.',format_price($asset_allocation_total_old_portfolio))[0]}} </td>
                          <td> {{explode('.',format_price($asset_allocation_total_advised_portfolio))[0]}}</td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <div class="accordion-item" style="margin-bottom: 20px;">
              <div id="headingOne">
                <h2 class="accordion-header mb-0" id="flush-headingOne">
                  <button class="accordion-button collapsed" style="font-size: 13px; font-weight: 600;padding: 16px 20px;border: none;" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwelveth" aria-expanded="false" aria-controls="flush-collapseTwelveth">
                    <img src="{{asset('frontend/assets/images/advisory/equity.png')}}" class="mr-2" style="margin-top: -7px;" alt="" srcset="">
                      ASSUMPTION LOGIC
                  </button>
                </h2>
              </div>
              <div id="flush-collapseTwelveth" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                  <table class="table table-striped table-responsives">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                        @foreach (getAssumptionLogicRecods() as $assumption_logic)
                          <tr>
