                    ...
                    @if($payouts->count() > 0)
                        @foreach($payouts as  $payout)
                            <tr>
                                ...
                                <td  class="text-center"><a style="" class="text-primary" href="{{ route('panel.payouts.show', $payout->id) }}">#POUT{{  $loop->iteration }}</a></td>
                                    <td class="col_1">{{fetchFirst('App\User',$payout->user_id,'name','--')}}</td>
