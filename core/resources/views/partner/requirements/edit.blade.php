                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="category_id" id="category_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\CategoryType::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $requirement->category_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="sub_category_id" id="sub_category_id" class="form-control select2">
                                            ...
                                            @foreach(App\Models\Category::all()  as $option)
                                                <option value="{{ $option->id }}" {{ $requirement->sub_category_id  ==  $option->id ? 'selected' : ''}}>{{  $option->name ?? ''}}</option> 
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                        ...
                                        <select required name="status" id="status" class="form-control select2">
                                            <option value="" readonly>Select Status</option>
                                                @foreach(getRequirementStatus() as $option)
                                                    <option value=" {{  $option['id'] }}" {{   $requirement->status  ==  $option['id']  ? 'selected' : ''}}>{{ $option['name']}}</option> 
                                                @endforeach
                                          </select>
                                    </div>
                                </div>                                                           
                                        ...
                                        <select required name="type" id="type" class="form-control select2">
                                            <option value="" readonly>Select Type</option>
                                                ...
                                                @foreach(getRequirementType() as $option)
                                                    <option value=" {{  $option['id'] }}" {{   $requirement->type  ==  $option['name']  ? 'selected' : ''}}>{{ $option['name']}}</option> 
                                                @endforeach
                                          </select>
                                    </div>
                                </div>
                                <div class="col-md-12 col-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea  class="form-control" name="location" id="location" placeholder="Enter Location">{{$requirement->location }}</textarea>
                                    </div>
                                </div>                             
